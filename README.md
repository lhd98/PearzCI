...
For an agent without access to Xcode's Apple account, set
`IOS_PROVISIONING_PROFILE_SPECIFIER` to an installed development profile name;
PearzCI then uses manual signing for the device build.
